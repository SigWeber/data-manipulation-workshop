...
```{r message=FALSE}
universities <- read_csv("https://raw.githubusercontent.com/SigWeber/data_manipulation_with_R//master/data/universities.csv")
cities <- read_csv("https://raw.githubusercontent.com/SigWeber/data_manipulation_with_R//master/data/cities.csv")
states <- read_csv("https://raw.githubusercontent.com/SigWeber/data_manipulation_with_R//master/data/states.csv")
```
