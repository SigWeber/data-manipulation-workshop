...
1. Load the following datasets:
    ...
    ```{r message=FALSE}
    presidents <- read_csv("https://raw.githubusercontent.com/SigWeber/data-manipulation-workshop/master/data/presidents.csv")
    presidents_home <- read_csv("https://raw.githubusercontent.com/SigWeber/data-manipulation-workshop/master/data/presidents_home.csv")
    ```
